...
Проведены эксперименты с тремя типами Residual-блоков:
    ...
    Блок	       | Параметры |Лучшая Test Acc |     Итоги обучения (5 эпох)
BasicResidualBlock |    5034   |	 84.31%     | Быстрая сходимость, стабильность
BottleneckBlock	   |    1194   |	 69.32%     | Медленная сходимость, хуже итоговое качество
WideResidualBlock  |    9594   |	 76.15%     | Улучшенное качество на ранних эпохах
